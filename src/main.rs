...
// A struct to deserialize the JSON response from the OpenWeatherMap API
...
fn display_weather_info(response: &WeatherResponse) {
    ...
    //Colouring the weather based on the weather conditions
    let weather_text_coloured: ColoredString = match description {
        "clear sky" => weather_text.bright_yellow(),
        "few clouds" | "scattered_clouds" | "broken clouds" => 
...
fn main() {
    ...
    loop {
        ...
        println!("{}", "Please enter a country code, e.g US for United states".bright_green());
        let mut country_code = String::new();
        io::stdin().read_line(&mut country_code).expect("failed to enter a country code");
